 ...
 * {@link FemaleResults.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link FemaleResults#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FemaleResults extends Fragment {
    ...
    FemaleSportResultListRecyclerAdapter adapter;

    public static FemaleResults contextFemaleRes;
     ...
     * @return A new instance of fragment FemaleResults.
     */
    // TODO: Rename and change types and number of parameters
    public static FemaleResults newInstance(String param1, String param2) {
        FemaleResults fragment = new FemaleResults();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_female_results, container, false);


        List<FemaleSportResultListData> list = new ArrayList<>();
        //list = getData();

        recycler
                = (RecyclerView)view.findViewById(
                R.id.sport_result_female_recycler);
        adapter
                = new FemaleSportResultListRecyclerAdapter(
        ...
        FrameLayout frameLayout=view.findViewById(R.id.frameLayFemaleRes);
        frameLayout.setBackgroundResource(Constants.backgroundForSport.get(sport_name));

        //gettingData.getSportData(sport_name, "female", "live", list, adapter, mDataReference);
    ...
    private List<FemaleSportResultListData> getData() {
        List<FemaleSportResultListData> list = new ArrayList<>();
