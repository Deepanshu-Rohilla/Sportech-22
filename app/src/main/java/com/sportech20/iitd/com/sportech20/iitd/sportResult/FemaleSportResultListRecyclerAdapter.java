...
public class FemaleSportResultListRecyclerAdapter extends RecyclerView.Adapter<FemaleSportResultRecyclerViewHolder> {

    List<FemaleSportResultListData> list
    ...
    @Override
    public FemaleSportResultRecyclerViewHolder
                       ...
                       int viewType)
    {
        ...
        FemaleSportResultRecyclerViewHolder viewHolder
                = new FemaleSportResultRecyclerViewHolder(photoView);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull final FemaleSportResultRecyclerViewHolder viewHolder, final int position) {
